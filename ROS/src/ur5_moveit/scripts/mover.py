...
from ur5_moveit.srv import MoverService, MoverServiceRequest, MoverServiceResponse
...
def moveit_server():
    ...
    rospy.init_node('ur5_moveit_server')

    s = rospy.Service('ur5_moveit', MoverService, plan_pick_and_place)
    print("Ready to plan")
    rospy.spin()
