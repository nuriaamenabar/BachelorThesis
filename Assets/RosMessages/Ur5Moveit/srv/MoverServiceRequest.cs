...
namespace RosMessageTypes.Ur5Moveit
{
    ...
    {
        public const string k_RosMessageName = "ur5_moveit/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public Ur5MoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new Ur5MoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(Ur5MoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = Ur5MoveitJointsMsg.Deserialize(deserializer);
